...
import { Vehicle, VehicleID, CreatedVehicle, OwnerID, DefaultVehicleDetails } from '../src/vehicle/schema'
...
test('Default Vehicle schema loads correctly', () => {
  // Create instance of User
  const testUser = new DefaultVehicleDetails()
  testUser.id = "b20ec061-2957-4c3b-b193-c8b40138e8f1"
  expect(testUser).toBeDefined()
});